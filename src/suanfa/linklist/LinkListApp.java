 ...
 * @Description TODO
 * @Author wangheng
 * @Date 2019/11/18 0018 上午 9:32
 */
//定义单个链接点
class Link1 {
    public int iData;                                //节点保存的整型数据
    public double dData;                            //节点保存的双精度浮点型数据
    public Link1 next;                                //节点所指向的下一个节点

    public Link1(int id, double dd)                //构造函数
    {
        this.iData = id;
        this.dData = dd;
    }
...
//定义链表
class LinkList {
    private Link1 first;                                //定义节点的第一个节点
    ...
    public Link1 delete(int key)                        //根据整形数据删除相应节点
    {
        Link1 current = this.first;
    ...
    public void dispalyList() {
        ...
        Link1 current = this.first;                    //从头节点开始
...
public class LinkListApp {
    public static void main(String[] args) {
        ...
        Link1 fLink = theList.find(2);                //查找节点
        if (fLink != null) {
